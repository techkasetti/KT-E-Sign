...
//     get totalRequests() {
//         return this.analyticsData ? this.analyticsData.totalRequests : 0;
//     }
...
//     get activeUsers() {
//         return this.analyticsData ? this.analyticsData.activeUsers : 0;
//     }
    
//     get systemStatus() {
//         return this.analyticsData ? this.analyticsData.systemStatus : 'Unknown';
//     }
...
// if (!canvas || !this.analyticsData.statusDistribution) return; const ctx = canvas.getContext('2d');
// const statusData = this.analyticsData.statusDistribution; // Destroy existing chart if it exists
// if (this.statusChart) {
...
// if (!canvas || !this.analyticsData.methodDistribution) return; const ctx = canvas.getContext('2d');
// const methodData = this.analyticsData.methodDistribution; // Destroy existing chart if it exists
// if (this.methodChart) {
...
// backgroundColor: [
// 'rgba(23, 162, 184, 0.8)', // Typed - Blue
// 'rgba(40, 167, 69, 0.8)', // Drawn - Green
// 'rgba(255, 193, 7, 0.8)' // Upload - Yellow
// ],
// borderColor: [
// '#17a2b8',
// '#28a745',
...
// if (!canvas || !this.analyticsData.completionTrends) return; const ctx = canvas.getContext('2d');
// const trendsData = this.analyticsData.completionTrends; // Destroy existing chart if it exists
// if (this.trendsChart) {
